  ...
  return (
    <div className="app-width flex flex-col md:flex-row justify-between items-center gap-20 mt-20">
      <div className="flex-1">
        <div className="bg-[#92CD0033]/20 px-2 py-3 rounded w-max text-xs text-[#2C6700] font-medium">Our Subsidiaries</div>
        ...
        <Button size="md"  className="bg-black mt-5">Visit our website</Button>
      </div>
      <div className="flex-1">
